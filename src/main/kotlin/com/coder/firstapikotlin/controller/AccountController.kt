package com.coder.firstapikotlin.controller

import com.coder.firstapikotlin.model.Account
import com.coder.firstapikotlin.service.AccountService
...
class AccountController (private val service:AccountService){
    ...
    @PutMapping("/{id}")
    fun update(@PathVariable id: Long, @RequestBody account: Account): ResponseEntity<Account> = service.update(id, account).map {
        ResponseEntity.ok(it)
    }.orElse(ResponseEntity.notFound().build())
